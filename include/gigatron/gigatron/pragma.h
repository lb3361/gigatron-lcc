...
/* ==== Pragmas ====
   ...
   * #pragma glcc lomem("MODNAME","FRAGNAME")
     ...
     in low memory regardless of their module name. Unlike the placement
     attributes discussed later in this documeet, the lomem pragma can
     affect the placement of code amd functions defined elsewhere/
     them.
